...
fun FeedListScreen(
        ...
        LazyColumn(
            ...
            items(state.items) { item ->
                Column(modifier = Modifier.fillMaxWidth()) {
                    ...
                    Text(
                        text = item.content?.content?.toString().orEmpty(),
                    ...
                    Row(
                        ...
                        Button(
                            onClick = {
                                onDetailClicked(item.uuid.toString())
                            },
                        ) {
                            Text("Open")
                        }
                        ...
                        Button(
                            onClick = {
                                onEditClicked(item.uuid.toString())
                            },
                        ) {
                            Text("Bewerk")
                        }
    ...
    pendingDeleteId?.let { deleteId ->
        AlertDialog(
            ...
            text = {
                Text("Dit item wordt soft-deleted en verdwijnt uit de feed.")
            },
            confirmButton = {
                Button(
                    onClick = {
